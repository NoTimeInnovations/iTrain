  ...
  return (
    ...
    >
      ...
      <div className="min-h-screen bg-secondary bg-opacity-50 text-textColor px-5 md:px-20 py-[100px] xl:px-[200px] grid grid-rows-[min-content,1fr]">
        {/* title  */}
        <p className="text-lg font-medium md:text-4xl  xl:leading-[40px] text-center">
          Vision and Mission
        </p>
        ...
        <div className="grid place-items-center gap-10">
            {
                contents.map((c,index)=>(
                    <div key={`about_page_${index == 0 ? 'vision' : 'mission'}`} className="grid place-items-center gap-5 text-center max-w-[700px] ">
